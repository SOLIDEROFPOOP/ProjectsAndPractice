create expense tracker with password 'password';
create database expensetrackerdb with template=template0 owner=expensetracker;
connect expensetrackerdb;
alter default priveleges grant all on tables to expensetracker;
alter default priveleges grant all on sequences to expensetracker;
